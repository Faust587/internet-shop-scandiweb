...
const ChangeCurrencyButton = () => {
  ...
  const {data, loading, error} = useQuery<dataType>(GET_CURRENCIES_QUERY);
...
const DropdownMenu = styled.ul<styledPropsType>`
  position: absolute;
  top: 75%;
  left: -50%;
  width: 100px;
...
const DropdownMenuState = styled.div<styledPropsType>`
  display: flex;
  align-self: center;
  width: 8px;
  height: 4px;
